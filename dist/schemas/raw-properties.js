...
export const created_time = propertySchema("created_time", z.string().datetime());
export const last_edited_by = propertySchema("last_edited_by", userObjectResponse);
export const last_edited_time = propertySchema("last_edited_time", z.string().datetime());
